...
| 6   | Resize                                 | DEFERRED (DEF-3)       | MANUAL confirmed via `npm run demo:resize` — ✓ Linux, ✓ macOS (over SSH), ✓ Windows. Only automated real-PTY delivery remains deferred (DEF-3)                                          |
...
| DEF-3 | real-PTY SIGWINCH resize delivery (automated). Manual: ✓ Linux, ✓ macOS over SSH, ✓ Windows (all confirmed) | 6 Resize                                               |
