...
> **Last Updated**: 2026-07-01 (RD-11 **shipped** — DEF-16 ✅ Shipped via the `Dialog` `valid()` close-gate)
...
| High-value controls: `History` · `Tree` · `ComboBox` · `Tabs` · `Table`/`DataGrid` (incl. RD-11's deferred multi-column `ListViewer` `numCols`, AR-104) · `ProgressBar`/`Spinner` · `Surface` (+ DEF-01…DEF-03) | **RD-07** | ⬜ Backlog |
